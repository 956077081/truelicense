 ...
 * License生成类需要的参数
 */
public class LicenseGeneateParam {
     ...
     * 额外的服务器硬件校验信息
     */
    private LicenseExtraParam licenseExtraModel;
    ...
    public LicenseExtraParam getLicenseExtraModel() {
        return licenseExtraModel;
    }

    public void setLicenseExtraModel(LicenseExtraParam licenseExtraModel) {
